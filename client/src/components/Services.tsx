...
const services = [
  ...
  },
  {
    ...
    description: "Развитие финансового мышления лидеров и карьерный рост в финансах.",
  ...
  },
  {
    ...
    description: "Стратегический партнёр на регулярной основе — рядом, когда нужно.",
