  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 max-w-5xl">
        <div
          className="rounded-3xl p-8 md:p-16 text-white shadow-2xl relative overflow-hidden"
          ...
          <div className="relative z-10 grid md:grid-cols-[2fr,1fr] gap-12">
            <div>
              ...
              >
                ...
                , сопровождала сделки M&A, преодолевала кризисы и фазы взрывного
                роста.
              </p>
              <p
              ...
              >
                ...
                внутренние процессы с ростом до финансового директора в
                компаниях с оборотом до 50+ млрд рублей. Работала в российском и
                международном бизнесе — в условиях санкций, M&A, кризисов и
                взрывного роста. Сегодня помогаю лидерам выстраивать финансовую
                ...
                {[
                  {
                    ...
                    text: "Deloitte · Linde · Weatherford",
                  },
                  {
                    icon: <GraduationCap className="w-4 h-4" />,
                    text: "EMBA РАНХиГС / Kingston",
                  },
            ...
            {/* Stats */}
            <div
              className="flex flex-col justify-start gap-10 border-l pl-8 md:pl-12"
